...
void KeyBacklight::drawGuage(int x, int y, int w, int h, int pos, QColor color, QPainter *p)
{
	int cy1, cy2, cheight;
...
QObject * KeyBacklight::getQObject()
{
	return this;
}

QString KeyBacklight::getName()
{
    return tr("Key Backlight");
}
